...
public class ComplexData {
    ...
    public static void update(Profile profile) {
        ...
        if (profile.enabled.profilerTimings) {
            ...
            if (CLIENT.tickTimeTracker.getResult() == null) {
                ...
                List<ProfilerTiming> timings = CLIENT.tickTimeTracker.getResult().getTimings("root");
                timings.remove(0);
    ...
    public static ProfilerTimingWithPath getEntries(ProfilerTiming timing, String path) {
        ...
        List<ProfilerTiming> timings = CLIENT.tickTimeTracker.getResult().getTimings(path);
        timings.remove(0);
        for (var entry : timings)
